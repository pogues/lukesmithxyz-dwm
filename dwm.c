...
/* per tag settings of the mfact widths / layouts */
struct Pertag {
...
/* keet the autostarted PIDs to kill them on quit */
static pid_t *autostart_pids = NULL;
static size_t autostart_len = 0;
...
/* execute commands from autostart array */
static void
autostart_exec(void)
{
    const char *const *p;
